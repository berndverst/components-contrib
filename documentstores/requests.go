...
func (r DeleteDocumentRequest) GetKey() string {
	return r.Key
}

// Metadata gets the Metadata on a DeleteRequest.
func (r DeleteDocumentRequest) GetMetadata() map[string]string {
	return r.Metadata
}
...
func (r CreateDocumentRequest) GetKey() string {
	return r.Key
}

// GetMetadata gets the Key on a SetRequest.
func (r CreateDocumentRequest) GetMetadata() map[string]string {
	return r.Metadata
}
