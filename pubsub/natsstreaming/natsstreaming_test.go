...
func TestSubscriptionOptionsForValidOptions(t *testing.T) {
	...
	tests := []test{
		...
		{"using startAtSequence", natsMetadata{StartAtSequence: uint64(42)}, 2},
		...
		{"using manual ack with maxInFlight", natsMetadata{MaxInFlight: uint64(42)}, 2},
	}
...
func TestSubscriptionOptionsForInvalidOptions(t *testing.T) {
	...
	tests := []test{
		{"startAtSequence is less than 1", natsMetadata{StartAtSequence: uint64(0)}},
